...
LuScreen 是一款专为 Windows 平台打造的**高性能、全功能屏幕创作工具**。它不仅支持高帧率录屏和长截图，更创新性地引入了**手绘风格标注**，让技术文档和演示视频充满温度。无论是软件演示、Bug 汇报、教学课件制作，还是日常灵感捕捉，LuScreen 都能提供流畅、专业的体验。只要长按鼠标右键 2 秒，即可调出工具栏。

![LuScreen 产品概览](assets/webimages/feature-main.png)
...
![截图功能](assets/webimages/feature-screenshot.png)
![滚动长截图](assets/webimages/feature-longshot.png)

### 🎥 功能2：视频录制
*   **多模式录制**：支持**全屏录制**与**区域录制**，无论是录制整个桌面还是单一窗口，都能精准把控。
*   **高清高帧率**：最高支持 **4K 60FPS** 录制，采用 H.264 编码，适合游戏高光、软件演示与高清教程场景，尽可能保留画面细节。
*   **鼠标跟踪自动缩放功能**：画面随着鼠标点击而放大，属于更适合进阶演示与高阶录屏创作的高级技能。
*   **音画同步**：
...
![视频录制功能](assets/webimages/feature-recording.png)
...
![OCR 识字功能](assets/webimages/feature-ocr.png)
...
![智能画板功能](assets/webimages/feature-drawpad.png)
...
![智能剪贴板功能](assets/webimages/feature-cutpad.png)
...
![微信交流群二维码](assets/webimages/qrcode.png)
