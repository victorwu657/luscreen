...
setlocal
cd /d "%~dp0"
set "LUSCREEN_WINDOWS_CONSOLE_MODE=disable"
set "LUSCREEN_PACKAGE_FLAVOR=release"
...
echo ========================================
echo LuScreen Release Build And Pack
echo ========================================
...
echo ========================================
echo Pack completed
echo Installer path: dist_installer\LuScreen-Setup-v%APP_VERSION%.exe
echo ========================================
pause
exit /b 0
