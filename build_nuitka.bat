...
%PY% -m nuitka ^
 ...
 --nofollow-import-to=distro ^
 --nofollow-import-to=jiter ^
 ...
 --nofollow-import-to=shapely.tests ^
 --nofollow-import-to=shapely.vectorized ^
 --nofollow-import-to=torch ^
 --nofollow-import-to=whisperx ^
 --nofollow-import-to=transformers ^
 --no-deployment-flag=excluded-module-usage ^
 --include-qt-plugins=multimedia,platforms,styles,imageformats,iconengines ^
 ...
 --include-module=rust_core ^
!RAPIDOCR_NUITKA_OPTS! ^
 ...
 --include-data-file=models/manifest.json=models/manifest.json ^
