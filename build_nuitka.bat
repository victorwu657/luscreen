...
echo ========================================================
echo  Build Complete!
echo  The executable is located in: dist_nuitka\LuScreen.exe
echo  SUCCESS: ffmpeg.exe has been embedded inside LuScreen.exe.
echo  You can now distribute JUST the LuScreen.exe file.
echo ========================================================
pause